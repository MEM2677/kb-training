...
<s:form action="saveConfig" namespace="/do/jptableau/Tableau/Page/SpecialWidget/jptableauTableauConfig" cssClass="form-horizontal">
		...
		<div class="form-group margin-base-top">
			<div class="col-xs-12">
				...
				<div class="input-group">
					<wpsf:select list="tableausId" name="id" id="id" cssClass="form-control" />
